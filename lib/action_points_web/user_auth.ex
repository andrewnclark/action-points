defmodule ActionPointsWeb.UserAuth do
  @moduledoc """
  Session plumbing for authenticated users: session tokens, the plugs that read
  them, and the LiveView `on_mount` hooks that put the current Scope in place.

  Generated by `phx.gen.auth` and kept close to the generated shape, so that
  upstream changes stay easy to follow.
  """
